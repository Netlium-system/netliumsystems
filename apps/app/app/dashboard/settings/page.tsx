...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-8 py-8">
      <div>
        <h1 className="text-h1 font-semibold tracking-tight text-text-primary">Settings</h1>
        <p className="mt-2 text-body text-text-secondary">Account, security, and preference management</p>
      </div>
